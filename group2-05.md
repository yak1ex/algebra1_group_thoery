...
以下の乗積表より、$\mathfrak{S}_3$の位数$2$の元の集合$S = \{ (1\;2),(2\;3),(1\;3) \}$でかつ$\mathfrak{S}_3 = \langle S \rangle$である。※演習問題2.3.9(1)(p.70)から互換2つで生成できることも言える
※(1 2 3)と(1 2)に分解すると2×3=6って言いやすいかも
...
これは$\psi$の決め方が**高々**$6$通りということである。※決めたときにちゃんと写像が定まるか分からないので「高々」
