...
1. $24=2^3\cdot3$ なので $|H|=8$ である。シロー $2$ 部分群の数を $s$ とすると、(第2版)p.119定理4.5.7(4)より $s\equiv1\mod2$ である。また $H\subset N_G(H)$ なので、 $s=(G:N_G(H))$ は $(G:H)=3$ の約数でもある。よって $s$ は $1,3$ のいずれかである。以下によりいずれの場合も $G$ が非自明な正規部分群を持つため $G$ は単純群ではない。
   1. $s=1$ の場合、 $H$ の共役が $H$ のみであるため、 $H\triangleleft G$ かつ $|H|=8$ であるから $G$ は非自明な正規部分群を持つ。
   2. $s=3$ の場合、シロー $2$ 部分群を $H_1, H_2, H_3$ と置く。 $G$ の $\lbrace H_1,H_2,H_3\rbrace$ に対する共役による作用の置換表現 $\rho:G\rightarrow\mathfrak{S}_3$ を考える。(第2版)p.100 命題4.1.12より $\rho$ は群の準同型であるため、(第2版)p.61 命題2.8.3より $\mathrm{Ker}(\rho)\triangleleft G$ となるので、 $G$ は正規部分群を持つ。p.70 定理2.10.1(準同型定理)から $G/\mathrm{Ker}(\rho)\cong\mathrm{Im}(\rho)$ でp.119 定理4.5.7(3)より $G$ のすべてのシロー $2$ 部分群が共役であることから少なくとも $3\le|\mathrm{Im}(\rho)|\le6$ なので $4\le|\mathrm{Ker}(\rho)|\le8$ となり $\mathrm{Ker}(\rho)$ は $G$ の非自明な正規部分群となる。
   ※非自明な正規部分群であることはこちらの方が明快：$|G|=24\gt|\mathfrak{S}_3|=6$ なので $\rho$ は単射ではない。よってp.49 命題2.5.15から $\mathrm{Ker}(\rho)\neq\lbrace1_G\rbrace$ 、また $\mathrm{Ker}(\rho)=G$ とすると $H_1,H_2,H_3$ が共役にならないので $\mathrm{Ker}(\rho)\neq G$
2. $36=2^2\cdot3^2$ 、シロー $3$ 部分群を $H$ とすると $|H|=9$ である。シロー $3$ 部分群の数を $s$ とすると、(第2版)p.119定理4.5.7(4)より $s\equiv1\mod3$ である。また $H\subset N_G(H)$ なので、 $s=(G:N_G(H))$ は $(G:H)=2^2=4$ の約数でもある。よって $s$ は $1,4$ のいずれかとなる。以下によりいずれの場合も $G$ が非自明な正規部分群を持つため $G$ は単純群ではない。
   1. $s=1$ の場合、 $H$ の共役が $H$ のみであるため、 $H\triangleleft G$ かつ $|H|=9$ であるから $G$ は非自明な正規部分群を持つ。
   2. $s=4$ の場合、シロー $3$ 部分群を $H_1, H_2, H_3,H_4$ と置く。 $G$ の $\lbrace H_1,H_2,H_3,H_4\rbrace$ に対する共役による作用の置換表現 $\rho:G\rightarrow\mathfrak{S}_4$ を考える。(第2版)p.100 命題4.1.12より $\rho$ は群の準同型であるため、(第2版)p.61 命題2.8.3より $\mathrm{Ker}(\rho)\triangleleft G$ となるので、 $G$ は正規部分群を持つ。 $|G|=36\gt|\mathfrak{S}_4|=24$ なので $\rho$ は単射ではない。よってp.49 命題2.5.15から $\mathrm{Ker}(\rho)\neq\lbrace1_G\rbrace$ 、また $\mathrm{Ker}(\rho)=G$ とすると $H_1,H_2,H_3,H_4$ が共役にならないので $\mathrm{Ker}(\rho)\neq G$ となるから $\mathrm{Ker}(\rho)$ は $G$ の非自明な正規部分群である。
3. $48=2^4\cdot3$ 、シロー $2$ 部分群を $H$ とすると $|H|=16$ である。シロー $2$ 部分群の数を $s$ とすると、(第2版)p.119定理4.5.7(4)より $s\equiv1\mod2$ である。また $H\subset N_G(H)$ なので、 $s=(G:N_G(H))$ は $(G:H)=3$ の約数でもある。よって $s$ は $1,3$ のいずれかとなる。以下によりいずれの場合も $G$ が非自明な正規部分群を持つため $G$ は単純群ではない。
   1. $s=1$ の場合、 $H$ の共役が $H$ のみであるため、 $H\triangleleft G$ かつ $|H|=16$ であるから $G$ は非自明な正規部分群を持つ。
   2. $s=3$ の場合、シロー $2$ 部分群を $H_1,H_2,H_3$ と置く。 $G$ の $\lbrace H_1,H_2,H_3\rbrace$ に対する共役による作用の置換表現 $\rho:G\rightarrow\mathfrak{S}_3$ を考える。(第2版)p.100 命題4.1.12より $\rho$ は群の準同型であるため、(第2版)p.61 命題2.8.3より $\mathrm{Ker}(\rho)\triangleleft G$ となるので、 $G$ は正規部分群を持つ。 $|G|=48\gt|\mathfrak{S}_3|=6$ なので $\rho$ は単射ではない。よってp.49 命題2.5.15から $\mathrm{Ker}(\rho)\neq\lbrace1_G\rbrace$ 、また $\mathrm{Ker}(\rho)=G$ とすると $H_1,H_2,H_3$ が共役にならないので $\mathrm{Ker}(\rho)\neq G$ となるから $\mathrm{Ker}(\rho)$ は $G$ の非自明な正規部分群である。
   3. 
...
|2|位数が素数なのでアーベル群(巡回群)|
|3|位数が素数なのでアーベル群(巡回群)|
|4|位数が素数の $2$ 乗なので p.117 命題4.4.4よりアーベル群|
|5|位数が素数なのでアーベル群(巡回群)|
|6|位数が $2\cdot3$ で $2$ 素数の積なので演習問題4.5.3(1)|
|7|位数が素数なのでアーベル群(巡回群)|
|8|$p$ 群なのでp.116 命題4.4.3から $Z(G)\neq\lbrace1\rbrace$ 、つまりアーベル群であるか非自明な正規部分群を持つ|
|9|位数が素数の $2$ 乗なので p.117 命題4.4.4よりアーベル群|
|10|位数が $2\cdot5$ で $2$ 素数の積なので演習問題4.5.3(1)|
|11|位数が素数なのでアーベル群(巡回群)|
|12|位数が $2^2\cdot3$ なので演習問題4.5.7より非自明な正規部分群を持つ|
|13|位数が素数なのでアーベル群(巡回群)|
|14|位数が $2\cdot7$ で $2$ 素数の積なので演習問題4.5.3(1)|
|15|位数が $3\cdot5$ で $2$ 素数の積なので演習問題4.5.3(1)|
|16|$p$ 群なのでp.116 命題4.4.3から $Z(G)\neq\lbrace1\rbrace$ 、つまりアーベル群であるか非自明な正規部分群を持つ|
|17|位数が素数なのでアーベル群(巡回群)|
|18|位数が $3^2\cdot2$ なので演習問題4.5.7より非自明な正規部分群を持つ|
|19|位数が素数なのでアーベル群(巡回群)|
|20|位数が $2^2\cdot5$ なので演習問題4.5.7より非自明な正規部分群を持つ|
|21|位数が $2$ 素数の積なので演習問題4.5.3(1)|
|22|位数が $2$ 素数の積なので演習問題4.5.3(1)|
|23|位数が素数なのでアーベル群(巡回群)|
|24|演習問題4.5.8|
|25|位数が素数の $2$ 乗なので p.117 命題4.4.4よりアーベル群|
|26|位数が $2\cdot13$ で $2$ 素数の積なので演習問題4.5.3(1)|
|27|$p$ 群なのでp.116 命題4.4.3から $Z(G)\neq\lbrace1\rbrace$ 、つまりアーベル群であるか非自明な正規部分群を持つ|
|28|位数が $2^2\cdot7$ なので演習問題4.5.7より非自明な正規部分群を持つ|
|29|位数が素数なのでアーベル群(巡回群)|
|30|演習問題4.5.6|
|31|位数が素数なのでアーベル群(巡回群)|
|32|$p$ 群なのでp.116 命題4.4.3から $Z(G)\neq\lbrace1\rbrace$ 、つまりアーベル群であるか非自明な正規部分群を持つ|
|33|位数が $3\cdot11$ で $2$ 素数の積なので演習問題4.5.3(1)|
|34|位数が $2\cdot17$ で $2$ 素数の積なので演習問題4.5.3(1)|
|35|位数が $5\cdot7$ で $2$ 素数の積なので演習問題4.5.3(1)|
|36|演習問題4.5.8|
|37|位数が素数なのでアーベル群(巡回群)|
|38|位数が $2$ 素数の積なので演習問題4.5.3(1)|
|39|位数が $3\cdot13$ で $2$ 素数の積なので演習問題4.5.3(1)|
|40|演習問題4.5.4|
|41|位数が素数なのでアーベル群(巡回群)|
|42|演習問題4.5.4|
|43|位数が素数なのでアーベル群(巡回群)|
|44|位数が $2^2\cdot11$ なので演習問題4.5.7より非自明な正規部分群を持つ|
|45|位数が $3^2\cdot5$ なので演習問題4.5.7より非自明な正規部分群を持つ|
|46|位数が $2\cdot23$ で $2$ 素数の積なので演習問題4.5.3(1)|
|47|位数が素数なのでアーベル群(巡回群)|
|48|演習問題4.5.8|
|49|位数が素数の $2$ 乗なので p.117 命題4.4.4よりアーベル群|
|50|位数が $5^2\cdot2$ なので演習問題4.5.7より非自明な正規部分群を持つ|
|51|位数が $3\cdot17$ で $2$ 素数の積なので演習問題4.5.3(1)|
|52|位数が $2^2\cdot13$ なので演習問題4.5.7より非自明な正規部分群を持つ|
|53|位数が素数なのでアーベル群(巡回群)|
|54|演習問題4.5.4|
|55|位数が $5\cdot11$ で $2$ 素数の積なので演習問題4.5.3(1)|
|56|演習問題4.5.5|
|57|位数が $3\cdot19$ で $2$ 素数の積なので演習問題4.5.3(1)|
|58|位数が $2\cdot29$ で $2$ 素数の積なので演習問題4.5.3(1)|
|59|位数が素数なのでアーベル群(巡回群)|
